...
<div class="mentorOptions" id="mainContainer">
  ...
  ?>
    <a href="<?php echo navigation("mentor-fields", null, "user"); ?>">
      <button class="button-yellow-green button hoverAnimation" role="link">Para continuar. Llena los siguientes campos requeridos</button>
    </a>
  <?php
  }
  ?>
